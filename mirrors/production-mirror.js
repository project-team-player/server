...
const runMirror = async () => {
    try {
         ...
         */
        const copyFromDB = `${process.env.DB_CONN_STR1}${process.env.DATABASE_ROOT_USERNAME}${process.env.DB_CONN_STR2}${process.env.DATABASE_ROOT_PASSWORD}${process.env.DB_CONN_STR3}${process.env.DB_STAGING}${process.env.DB_CONN_STR4}`;
        const copyToDB = `${process.env.DB_CONN_STR1}${process.env.DATABASE_ROOT_USERNAME}${process.env.DB_CONN_STR2}${process.env.DATABASE_ROOT_PASSWORD}${process.env.DB_CONN_STR3}${process.env.DB_PRODUCTION}${process.env.DB_CONN_STR4}`;
